...
export const ro = {
  ...
  // ── sesiunea: ecranul de start ──────────────────────────────────────
  'sesiune.start.supratitlu': 'e ora de sală',
  'sesiune.start.titlu': 'Începe sesiunea',
  'sesiune.start.flexu':
    'Ai un plan? Alege-l. N-ai? <0>Mod liber</0> — alegi exercițiul, îi pui cifrele și ai pornit. Adaugi altele pe parcurs, iar la final poți salva tot ca plan. Cronometrul, apa și caloriile le țin eu.',
  'sesiune.start.modLiber': '🔥 MOD LIBER — începe acum',
  'sesiune.start.modLiberSub': 'alegi exercițiul pe loc, fără plan dinainte',
  'sesiune.start.planurile': 'Planurile tale',
  'sesiune.start.buton': '▶ START',
  'sesiune.start.incepeCuAsta': '▶ Începe cu ăsta',
  'sesiune.start.pornescGol': 'Pornesc gol, mă hotărăsc acolo',

  // ── sesiunea: ecranul live ──────────────────────────────────────────
  'sesiune.pauzaIntre': 'pauză între seturi',
  'sesiune.plus30': '+30s',
  'sesiune.sarPeste': 'Sar peste',
  'sesiune.sugestie.ceZici': '{motiv} Ce zici de <0>{exercitiu}</0>?',
  'sesiune.sugestie.adauga': 'Adaugă',
  'sesiune.sugestie.nuAcum': 'Nu acum',
  'sesiune.golFlexu':
    'Încă n-ai ales nimic. Apasă butonul de mai jos, caută aparatul sau exercițiul și dă-i drumul — nu trebuie să știi de la început tot ce faci azi.',
  'sesiune.alegePrimul': '+ Alege primul exercițiu',
  'sesiune.planAzi': 'Planul de azi',
  'sesiune.ceUrmeaza': '💡 Ce urmează?',
  'sesiune.activ': '▶ activ',
  'sesiune.seturiFacute': '{facute}/{total} seturi',
  'sesiune.repMaxim': 'maxim',
  'sesiune.scoateDinPlan': 'Scoate {exercitiu} din plan',
  'sesiune.adaugaExercitiu': '+ Adaugă exercițiu',
  'sesiune.notaAdaugare':
    'Exercițiul adăugat devine cel activ. Poți sări oricând înapoi la altul apăsând pe el în listă.',
  'sesiune.apa.titlu': '💧 Apă',
  'sesiune.apa.progres': '{bauti} / {tinta} ml',
  'sesiune.apa.buton': '+{ml} ml',
  'sesiune.ble.titlu': '📡 Ceas și aparat',
  'sesiune.ble.deconecteaza': 'Deconectează',
  'sesiune.ble.cautCeasul': 'Caut ceasul…',
  'sesiune.ble.ceasIntrebare': 'Ceas cu difuzare de puls (ex. Huawei GT4)?',
  'sesiune.ble.conecteazaCeas': '♥ Conectează',
  'sesiune.ble.ceasExplicatie':
    'Pe ceas: pornește un antrenament și activează „Difuzare ritm cardiac". Îl caut singur la începutul sesiunii, dar dacă browserul nu mă lasă, un tap aici rezolvă.',
  'sesiune.ble.cautAparatul': 'Caut aparatul…',
  'sesiune.ble.aparatIntrebare': 'Bandă sau rower cu Bluetooth?',
  'sesiune.ble.conecteazaAparat': '🔌 Conectează',
  'sesiune.ble.aparatExplicatie':
    'Pornește Bluetooth-ul de pe consola aparatului, apoi apasă aici. Preiau viteza, distanța și puterea direct de la el. Dacă nu-l găsesc, e în Setări un scaner care spune ce vorbește aparatul.',
  'sesiune.treciLaEl': '▶ Treci la el acum',
  'sesiune.pr.titlu': '🏆 RECORD PERSONAL!',
  'sesiune.pr.linie': '{tip}: <0>{valoare}</0>',
  'sesiune.pr.vechiul': 'vechiul record: {valoare}',
  'sesiune.pr.maiDeparte': 'Mergem mai departe! 🚀',
  'sesiune.stop.titlu': 'Închei sesiunea?',
  'sesiune.stop.rezumat': 'Ai {timp} de antrenament activ și {seturi} înregistrate.',
  'sesiune.stop.da': '✅ Da, închei — salvează tot',
  'sesiune.stop.nu': 'Nu, mă întorc la treabă',
  'sesiune.stop.abandon': 'Abandonez sesiunea',
  'sesiune.stop.abandonConfirmare': 'Sigur? Sesiunea va fi marcată ca abandonată.',
  // rostite cu voce tare, nu scrise pe ecran
  'sesiune.vocal.pauzaTerminata': 'Pauza s-a terminat. Următorul set!',
  'sesiune.vocal.record': 'Record personal! Felicitări!',

  // ── sesiunea: cardul exercițiului curent ────────────────────────────
  'sesiune.cumSeFace': 'cum se face? →',
  'sesiune.setulDin': 'Setul {n} din {total} · {echipament}',
  'sesiune.toateSeturile': 'Toate seturile bifate la exercițiul ăsta! Alege următorul din plan. 💪',
  'sesiune.rpe.intrebare': 'Cât de greu a fost? (RPE {rpe})',
  'sesiune.rpe.aria': 'Efort perceput',
  'sesiune.rpe.lejer': 'lejer',
  'sesiune.rpe.maxim': 'maxim',
  'sesiune.rpe.maximCu': 'maxim (RPE {rpe})',
  'sesiune.tempo.buton': '🎵 Tempo {tempo}',
  'sesiune.tempo.cuFaza': '🎵 Tempo {tempo} — {faza}',
  'sesiune.discuri': '🏋️ {greutate} kg = bara (20 kg) + <0>{discuri}</0> pe fiecare parte',
  'sesiune.discuriNimic': 'nimic',
  'sesiune.amTerminatSetul': '✔ Am terminat setul',
  'sesiune.tinta': 'țintă: {timp}',
  'sesiune.banda.viteza': 'Viteză',
  'sesiune.banda.inclinatie': 'Înclinație',
  'sesiune.banda.explicatie':
    'Schimbă-le din mers, exact cum le schimbi pe bandă — caloriile țin cont de fiecare porțiune. Intensitate acum: <0>{met} MET</0>',
  'sesiune.crono.continua': '▶ Continuă',
  'sesiune.crono.porneste': '▶ Pornește',
  'sesiune.crono.opreste': '⏸ Oprește',
  'sesiune.crono.reset': '↺ Reset',
  'sesiune.amTerminat': '✔ Am terminat ({timp})',

  // ── sesiunea: rezumatul final ───────────────────────────────────────
  'sesiune.rezumat.supratitlu': 'sesiune încheiată',
  'sesiune.rezumat.titlu': 'BRAVO! 🎉',
  'sesiune.rezumat.laSala': 'la sală',
  'sesiune.rezumat.kcal': 'kcal arse',
  'sesiune.rezumat.timpActiv': 'timp activ',
  'sesiune.rezumat.pauze': 'pauze {timp}',
  'sesiune.rezumat.seturi': 'seturi',
  'sesiune.rezumat.apa': 'apă băută',
  'sesiune.rezumat.catAiLucrat': 'cât ai lucrat',
  'sesiune.rezumat.realizari': 'Realizări deblocate!',
  'sesiune.rezumat.acasa': 'Acasă',
  'sesiune.salvat.titlu': '✅ Salvat ca plan!',
  'sesiune.salvat.unde': 'Îl găsești la Programe → Ale mele, gata de repetat.',
  'sesiune.salveazaPlan.buton': '💾 Salvează sesiunea ca plan',
  'sesiune.salveazaPlan.titlu': 'Salvezi ca plan?',
  'sesiune.salveazaPlan.explicatie':
    'Fac un plan din exercițiile și cifrele pe care le-ai bifat azi. Data viitoare îl pornești dintr-o atingere, fără să te mai gândești.',
  'sesiune.salveazaPlan.nume': 'Cum îl numim?',
  'sesiune.salveazaPlan.salveaza': '💾 Salvează planul',
  // textele astea se scriu în baza de date, în limba de la momentul salvării:
  // planul devine al utilizatorului, deci nu se mai retraduce niciodată
  'sesiune.numePlanImplicit': 'Sesiune {data}',
  'sesiune.salvatDescriere': 'Salvat dintr-o sesiune la sală',

  // ── antetul lipit al sesiunii ───────────────────────────────────────
  'hud.laSalaDe': 'la sală de',
  'hud.pauza': '⏸ Pauză',
  'hud.pauzaAria': 'Pauză',
  'hud.reia': '▶ Reia',
  'hud.reiaAria': 'Reia',
  'hud.opresteAria': 'Oprește sesiunea',
  'hud.conecteazaAria': 'Conectează ceasul cu puls',
  'hud.caut': '♥ caut…',
  'hud.conecteaza': '♥ conectează',
  'hud.activ': 'activ',
  'hud.pauzaUnitate': '+{timp} pauză',
  'hud.asteptDate': 'aștept date…',
  'hud.inPauza': '⏸ SESIUNE ÎN PAUZĂ — cronometrul de lucru stă pe loc',

  // ── economizorul de ecran ───────────────────────────────────────────
  'economizor.aria': 'Atinge pentru a reveni',
  'economizor.pauza': 'pauză',
  'economizor.pauzaScurt': '⏸ pauză',
  'economizor.reveni': 'atinge sau mișcă telefonul pentru a reveni',

  // ── „data trecută" ──────────────────────────────────────────────────
  'ultimaData.cand': 'data trecută · {cand}',
  'ultimaData.tinta': '🎯 Dacă azi merge ușor: încearcă {kg} kg × {reps}',
  'ultimaData.reia': '↩ Reia setările',
